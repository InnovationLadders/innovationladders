...
('التجارة الإلكترونية', 'تطوير متاجر إلكترونية احترافية ومتكاملة مع أنظمة الدفع والشحن', '["تصميم متجاوب", "أنظمة دفع آمنة", "إدارة الطلبات", "تحليلات المبيعات"]', 'Globe', 'from-indigo-500 to-purple-500', true, 6);
...
('نظام Odoo ERP', 'أنظمة ERP', 'الحل الأمثل لإدارة أعمال منشأتك التعليمية بالكامل نظام الموارد المؤسسية المتكامل (ERP)', '/images/portfolio/odoo-erp-system.webp', '["Odoo", "POS", "إدارة المخزون"]', '#', true, 1),
...
('تطبيق TryHub', 'تطبيقات الجوال', 'تطبيق تواصل اجتماعي لمشاركة التجارب الشخصية الناجحة', '/images/portfolio/tryhub-app.webp', '["React Native", "GPS", "Real-time"]', '#', true, 3),
...
('منصة مشروعي لإدارة المشاريع الطلابية', 'تطوير المواقع', 'منصة لادارة المشاريع الطلابية وتعزيز التعلم القائم على المشاريع', '/images/portfolio/mashrooi-platform.webp', '["React", "LMS", "Interactive"]', '#', true, 6);
...
('hero_section', '{
  ...
  "description": "شريكك في التحول الرقمي وحلول الأعمال المبتكرة\\nنقدم خدمات متكاملة من استشارات الابتكار إلى حلول التجارة الإلكترونية"
}'),
('about_section', '{
