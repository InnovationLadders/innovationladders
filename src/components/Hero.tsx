...
const Hero: React.FC = () => {
  const stats = [
    ...
    { icon: Award, number: '100+', label: 'مشروع ناجح' },
      ...
      <div className="container-custom relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              نحن نصنع
              <span className="block text-yellow-300">الإبداع والابتكار</span>
            </motion.h1>
            ...
            >
              معمل الإبداع بجدة - شريكك في التحول الرقمي وحلول الأعمال المبتكرة
              <br />
